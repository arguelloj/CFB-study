...
def loadSeq(fileName) :
    ...
    #print(linesList); #Print to test ouput
    ...
    #print(newList) ; #Print to test ouput
    ...
    for line in newList:
        if  '>' in line: 
                ...
                index = index + 1 ;
    #print(DNAstring); #Print the final single string: The concatenation of each line of DNA string in .fna fasta file. 
    return(DNAstring);