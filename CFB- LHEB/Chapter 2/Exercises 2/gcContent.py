#From the Computing for Biologits: Chapter 1
#Chapter Problem - gcContent.py
...
#0.5427
# This is a program used to
#calculate the GC Content, now for all DNA strings of any lengh.
def gcContent(DNA):
